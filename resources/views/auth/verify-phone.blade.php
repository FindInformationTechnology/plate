            ...
            <div class="col-lg-6 col-md-8 col-sm-10">
                <div class="card verification-card">
                    ...
                    <div class="card-header text-center bg-transparent border-0 pt-4">
                        ...
                        <h4 class="mb-2">{{ __('message.Verify_Phone_Number') }}</h4>
                    ...
                    <div class="card-body px-4 pb-4">
                        ...
                        <div class="resend-section text-center">
                            ...
                            <button class="btn btn-outline-secondary" disabled id="resendTimer">
                                ...
                                <span id="timerText">{{ __('message.Resend_Available_In') }} <span
                    ...
                    <div class="card-footer bg-transparent border-0">
                        ...
                        <div class="help-section">
                            <div class="row text-center g-2">
                                <div class="col-6">
                                    <a href="{{ route('user.profile') }}" class="btn btn-link btn-sm w-100">
                                        <i class="bx bx-edit me-1"></i>
                                        <span class="d-none d-sm-inline">{{ __('message.Change_Phone_Number') }}</span>
                                        <span class="d-sm-none">{{ __('message.Change_Phone') }}</span>
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="{{ route('contact') }}" class="btn btn-link btn-sm w-100">
