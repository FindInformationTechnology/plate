                            ...
                            <div class="card-body pt-0">
                                ...
                                <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                    ...
                                    @for ($i = 1; $i <= 10; $i++) <option value="{{ $i }} "
                                        {{ ( $category -> priority_level == $i ) ? "selected" : ""}}> {{ $i }} </option>
                                        @endfor
                        ...
                        <div class="card card-flush py-4">
                            ...
                            @foreach (Config('app.accepted_locales') as  $key => $value)
                                ...
                                <div class="mb-10 fv-row">
                                    <!--begin::Label-->
                                    <label class="required form-label">Category Name in  {{ $value }}</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="name[{{$key}}]" class="form-control mb-2" placeholder="Product name"
                                        value="{{ $category -> translate ('name', $key) }}" />
                                    <!--end::Input-->
                                ...
                                <div class="my-10">
                                    <!--begin::Label-->
                                    <label class="form-label">Description in {{ $value }}</label>
                                    <!--end::Label-->
                                    <!--begin::Editor-->
                                    <textarea class="form-control" name="description[{{$key}}]"
                                        aria-label="With textarea">{!! $category ->  translate ('description', $key) !!}</textarea>
                                    <!--end::Editor-->
                                ...
                                <div class="mb-10 {{ ($category -> parent_id == '') ? 'd-none' : '' }}"
                                    id="parent_cat_div">

                                    <!--begin::Select store template-->
                                    <label for="" class="form-label">Select Parent
                                        Category</label>
                                    <!--end::Select store template-->
                                    <!--begin::Select2-->
                                    <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" name="parent_id" id="parent-id">
                                        ...
                                        @foreach ($parentCategory->children as $childCategory)
                                            @include('admin::pages.categories.partials.edit-option', ['category' => $childCategory, 'level' =>
                                                 1, 'selectedParentId' => $category->parent_id])
                                            @endforeach
                                        @endforeach
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10">
                                    ...
                                    <textarea class="form-control" name="meta_descriptions"
                                        >{{ $category-> meta -> content ?? ''}}</textarea>
                                    <!--end::Editor-->
