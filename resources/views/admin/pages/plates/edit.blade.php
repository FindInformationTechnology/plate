            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card">
                    ...
                    <div class="card-body py-4">
                        <!--begin::Form-->
                        <form action="{{ route('admin.plates.update', $plate->id) }}" method="POST" class="form">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <select name="user_id" class="form-select form-select-solid" data-control="select2" data-placeholder="Select a user" required>
                                    ...
                                    @foreach($users as $user)
                                        <option value="{{ $user->id }}" {{ $plate->user_id == $user->id ? 'selected' : '' }}>{{ $user->name }} ({{ $user->email }})</option>
                                    @endforeach
                                </select>
                                <!--end::Select-->
                            </div>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="number" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Plate number" value="{{ $plate->number }}" required />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="number" name="length" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Plate length" value="{{ $plate->length }}" min="1" required />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="number" name="price" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Plate price" value="{{ $plate->price }}" min="0" step="0.01" required />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="fv-row mb-7">
                                <div class="form-check form-switch form-check-custom form-check-solid">
                                    <input class="form-check-input" type="checkbox" name="is_approved" id="is_approved" value="1" {{ $plate->is_approved ? 'checked' : '' }} />
                            ...
                            <div class="fv-row mb-7">
                                <div class="form-check form-switch form-check-custom form-check-solid">
                                    <input class="form-check-input" type="checkbox" name="is_sold" id="is_sold" value="1" {{ $plate->is_sold ? 'checked' : '' }} />
                            ...
                            <div class="fv-row mb-7">
                                <div class="form-check form-switch form-check-custom form-check-solid">
                                    <input class="form-check-input" type="checkbox" name="is_visible" id="is_visible" value="1" {{ $plate->is_visible ? 'checked' : '' }} />
