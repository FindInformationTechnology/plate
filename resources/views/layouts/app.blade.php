...
<head>
    ...
    <meta name="keywords"
        content="UAE license plates, Dubai number plates, Abu Dhabi plates, car plates, vehicle registration, premium plates, @yield('keywords', '')">
    ...
    <!-- Fontawesome CSS -->
    <link rel="stylesheet" href="{{ asset('assets/plugins/fontawesome/css/fontawesome.min.css')}}" media="print"
        onload="this.media='all'">
    <link rel="stylesheet" href="{{ asset('assets/plugins/fontawesome/css/all.min.css')}}" media="print"
        onload="this.media='all'">

    <!-- Fancybox CSS -->
    <link rel="stylesheet" href="{{ asset('assets/plugins/fancybox/fancybox.css')}}" media="print"
        onload="this.media='all'">
