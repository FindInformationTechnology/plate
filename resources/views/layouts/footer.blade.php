    ...
    <footer class="footer-two">
			<div class="sec-bg">
				...
				<img src="assets/img/bg/anchor-img-02.png" alt="Img">
			</div>
			<div class="container">
				...
				<div class="footer-bottom">
					...
					<div class="app-store-links d-flex align-items-center">
						<span class="me-2"><a href="javascript:void(0);"><img src="assets/img/icons/google-play.svg" alt="Img"></a></span>
						<span><a href="javascript:void(0);"><img src="assets/img/icons/app-store.svg" alt="Img"></a></span>
					</div>
				</div>
			</div>
		</footer>
