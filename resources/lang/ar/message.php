...
return [
    ...
    'Plate_is_a_premier_platform' => 'بليت35 هي منصة لبيع وشراء لوحات المركبات في دولة الإمارات. وهي مملوكة ومدارة من قبل شركة ريد كورنر للتجارة الإلكترونية، وهي شركة مرخصة في دولة الإمارات، حيث تربط بين البائعين والمشترين بطريقة سهلة وآمنة.',
...
',
    ...
    'Scroll_Left_To_See_More' => 'مرر يساراً لرؤية المزيد',
    ...
    'Your_new_password_must_be_different_from_previous_used_passwords' => 'يجب أن تكون كلمة المرور الجديدة مختلفة عن كلمات المرور المستخدمة سابقاً.',
    'New_Password' => 'كلمة المرور الجديدة',
    'Save_Changes' => 'حفظ التغييرات',
    'Thanks_signing_up_verify_email' => 'شكراً لتسجيلك! قبل البدء، هل يمكنك التحقق من عنوان بريدك الإلكتروني بالنقر على الرابط الذي أرسلناه إليك للتو؟ إذا لم تتلق البريد الإلكتروني، سنرسل لك واحداً آخر بكل سرور.',
