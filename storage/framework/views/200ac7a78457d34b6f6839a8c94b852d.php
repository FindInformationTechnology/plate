        ...
        <nav class="navbar navbar-expand-lg header-nav">
            <div class="navbar-header">
                ...
                <a href="<?php echo e(route('home')); ?>" class="navbar-brand logo">
                    <img src="<?php echo e(asset('assets/img/logo-b.png')); ?>" width="130" class="img-fluid"
                ...
                <ul class="main-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link header-reg btn btn-primary d-none d-md-block custom-btn"
                            ...
                            <?php echo e(__('message.advertise_here')); ?></a>
                    </li>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole('user')): ?>
                        ...
                        <li class="nav-item dropdown logged-item noti-nav noti-wrapper">
                            <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                                <span class="bell-icon"><img src="<?php echo e(asset('assets/img/icons/bell-icon.svg')); ?>"
                                        alt="Bell"></span>
                            ...
                            <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                                <span class="user-img">
                                    <img class="rounded-circle"
                                        src="<?php echo e(auth()->user()->profile_photo_url ?? asset('assets/img/profiles/avatar.webp')); ?>"
                                        alt="Profile">
                                </span>
...
<!-- /Header --><?php /**PATH C:\Users\dell\Desktop\plate\resources\views/layouts/header.blade.php ENDPATH**/ ?>