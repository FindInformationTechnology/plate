...
<head>
	...
	<link href="<?php echo e(asset ('assets/dashboard-assets/plugins/global/plugins.bundle.css')); ?>" rel="stylesheet" type="text/css" />
...
<body id="kt_body" class="bg-body">
		...
		<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(assets/media/illustrations/sketchy-1/14.png)">
			...
			<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
				...
				<a href="assets#" class="mb-12">
					<img alt="Find" src="<?php echo e(asset ('assets/dashboard-assets/media/logos/custom-1.png')); ?>" class="h-40px" />
				</a>
				<!--end::Logo-->
				<!--begin::Wrapper-->
	...
	<script src="<?php echo e(asset ('assets/dashboard-assets/js/custom/authentication/sign-in/general.js')); ?>"></script>
...
</html><?php /**PATH C:\Users\SOLO REAL ESTATE6\Desktop\Plate\resources\views/admin/pages/auth/login.blade.php ENDPATH**/ ?>