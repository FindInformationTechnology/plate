                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href=""
                                                    class="text-gray-800 text-hover-primary mb-1"><?php echo e($code->name); ?></a>

                                            </div>
                                            <!--begin::User details-->
                                        </td>
                                        <td><?php echo e($code->emirate ? $code->emirate->name : 'N/A'); ?></td>
...
<?php echo $__env->make('admin.pages.codes.partials.code_crud', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.btn-data').click(function () {
                ...
                $.get('<?php echo e(route("admin.codes.edit", ":id")); ?>'.replace(':id', id), function (data) {
                    // Set form action URL with the correct ID
                    $('#editForm').attr('action', '<?php echo e(route("admin.codes.update", "")); ?>/' + id);
            ...
            $('[data-kt-users-table-filter="delete_row"]').click(function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: '<?php echo e(route("admin.codes.destroy", "")); ?>/' + codeId,
                            type: 'DELETE',
                            data: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dell\Desktop\plate\resources\views/admin/pages/codes/index.blade.php ENDPATH**/ ?>