                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="current-image mb-3">
                                                        <label class="form-label"><?php echo e(__('message.Current_Image')); ?></label>
                                                        <div class="d-flex align-items-center">
                                                            <?php if($plate->image_url): ?>
                                                            <img src="<?php echo e(asset($plate->image_url)); ?>"
                                                            ...
                                                            <div class="form-check">
                                                                ...
                                                                <label class="form-check-label"
                                                                    for="removeImage"><?php echo e(__('message.Remove_current_image')); ?></label>
                                                            </div>
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="upload-div">
                                                        ...
                                                        <div class="upload-photo-drag">
                                                            <span><i class="fa fa-upload me-2"></i> <?php echo e(__('message.Update_Plate_Photo')); ?></span>
                                                            <h6><?php echo e(__('message.or_Drag_New_Photo')); ?></h6>
                                                        </div>
                                                    </div>
                                                    <div class="upload-list">
                                                        <ul>
                                                            <li><?php echo e(__('message.The_maximum_photo_size')); ?></li>
                                                            <li><?php echo e(__('message.Leave_empty_to_keep_the_current_image')); ?>.</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u465294331/domains/plate35.com/public_html/resources/views/user/plate/edit.blade.php ENDPATH**/ ?>