...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.toggle-status', function(e) {
            ...
            $.ajax({
                url: '<?php echo e(route("admin.plates.update-status")); ?>',
                type: 'POST',
                data: {
        ...
        $(document).on('click', '.toggle-sold', function(e) {
            ...
            $.ajax({
                url: '<?php echo e(route("admin.plates.update-sold")); ?>',
                type: 'POST',
                data: {
                    _token: '<?php echo e(csrf_token()); ?>',
                    id: plateId,
        ...
        $(document).on('click', '.delete-plate', function(e) {
            ...
            if (confirm('Are you sure you want to delete this plate?')) {
                $.ajax({
                    url: '<?php echo e(route("admin.plates.destroy")); ?>',
                    type: 'POST',
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>',
                        id: plateId
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u465294331/domains/plate35.com/public_html/resources/views/admin/pages/plates/index.blade.php ENDPATH**/ ?>