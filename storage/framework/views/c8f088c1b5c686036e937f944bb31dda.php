	...
	<div class="container">
				...
				<div class="col-md-6">
					<div class="footer-widget">
						<div class="widget-title">
							<div>
								<img src="<?php echo e(asset('assets/img/logo-b.png')); ?>" width="150" class="img-fluid"
									alt="Logo">
							</div>
							<p class="mt-3 mb-3"><?php echo e(__('message.Plate_is_a_premier_platform')); ?></p>
							<ul class="footer-address">
								<li><i
										class="fas fa-map-marker-alt me-2"></i><?php echo e(__('message.Dubai_United_Arab_Emirates')); ?>
								...
								<div class="widget-title">
									...
									<ul class="footer-links">
										<li><a href="<?php echo e(route('home')); ?>"><i
													class="fas fa-chevron-right"></i><?php echo e(__('message.Home')); ?></a></li>
										<!-- <li><a href=""><i class="fas fa-chevron-right"></i><?php echo e(__('message.About_Us')); ?></a></li> -->
										<li><a href="<?php echo e(route('plates')); ?>"><i
													class="fas fa-chevron-right"></i><?php echo e(__('message.Browse_Plates')); ?></a>
										</li>
								...
								<div class="widget-title">
									...
									<ul class="footer-links">
										...
										<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
											...
											<li><a href="<?php echo e(route('user.plates')); ?>"><i
														class="fas fa-chevron-right"></i><?php echo e(__('message.My_Plates')); ?></a>
											</li>
		...
		<div class="footer-bottom">
			<div class="copy-right">
				<p><?php echo e(__('message.Copyright')); ?> &copy; 2025 <span> Red Corner For Online Selling</span> .
					<?php echo e(__('message.All_Rights_Reserved')); ?>.</p>
			</div>
...
<!-- Footer --><?php /**PATH C:\Users\dell\Desktop\plate\resources\views/layouts/footer.blade.php ENDPATH**/ ?>