    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body px-5 my-7">
                <!--begin::Form-->
                <form id="myForm" class="form" action="<?php echo e(route('admin.emirates.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_emirate_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_emirate_header" data-kt-scroll-wrappers="#kt_modal_add_emirate_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="fv-row mb-7 mt-5">
                            ...
                            <!--end::Label-->
                            <!--begin::Image input-->
                            <div class="image-input image-input-empty image-input-outline" data-kt-image-input="true" style="background-image: url('<?php echo e(asset('assets/media/svg/avatars/blank.svg')); ?>')">
...
<div class="modal fade" id="kt_modal_edit_emirate" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body px-5 my-7">
                <!--begin::Form-->
                <form id="editForm" class="form" action="<?php echo e(route('admin.emirates.update', '')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<!--end::Modal - Edit Emirate--><?php /**PATH /home/u465294331/domains/plate35.com/public_html/resources/views/admin/pages/emirates/partials/emirate_crud.blade.php ENDPATH**/ ?>