    ...
    <div class="container">
        ...
        <form action="<?php echo e(route('user.plates.store')); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="row" id="info">
                <div class="col-lg-12 col-md-12">
                    <div class="heading-lising">
                        ...
                        <p class=""><?php echo e(__('message.Note')); ?>: <?php echo e(__('message.you_may_use')); ?> <strong>x, y</strong> <?php echo e(__('message.and')); ?> <strong>z</strong> <?php echo e(__('message.characters_to_hide_some_numbers')); ?></p>
                    </div>
                </div>
                <div class="col-lg-12 col-md-12">
                    <div class="card">
                                    ...
                                    <div class="table-responsive plates-table-container" id="table-container">
                                        <div class="scroll-indicator d-none" style="top: -5px;">
                                            <small class="">
                                                ...
                                                <?php else: ?>
                                                <?php echo e(__('message.Scroll_Left_To_See_More')); ?>
            ...
            <div class="booking-info-btns d-flex justify-content-end">
                <button class="btn btn-primary continue-book-btn btn-responsive" type="submit"><?php echo e(__('message.Save_All_Plates')); ?></button>
                <a href="<?php echo e(route('user.plates')); ?>" class="btn btn-secondary btn-responsive"><?php echo e(__('message.Cancel')); ?></a>
            </div>
        </form>
    </div>
</section>
